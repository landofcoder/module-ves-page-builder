    ...
    public function execute()
    {
        ...
        if ($post_data) {
            ...
            try {
                ...
                $data['layout_update_selected'] = isset($post_data['layout_update_selected'])?$post_data['layout_update_selected']:'_no_update_';
                $data['meta_keywords'] = isset($post_data['meta_keywords'])?$post_data['meta_keywords']:'';
                $data['meta_title'] = isset($post_data['meta_title'])?$post_data['meta_title']:'';
                $data['meta_description'] = isset($post_data['meta_description'])?$post_data['meta_description']:'';
                $data['amasty_hreflang_uuid'] = "";
                $data['ec_exclude_sitemap'] = 0;
                $data['mp_exclude_sitemap'] = 0;
                $data['exclude_sitemap'] = 0;
