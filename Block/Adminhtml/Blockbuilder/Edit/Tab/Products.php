...
class Products extends Extended
{
    ...
    protected function _construct()
    {
        ...
        if ($this->getBlockBuilder() && $this->getBlockBuilder()->getId()) {
    ...
    {
        return $this->getBlockBuilder() && $this->getBlockBuilder()->getRelatedReadonly();
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'position',
                'editable' => !$this->getBlockBuilder()->getRelatedReadonly(),
                'edit_only' => !$this->getBlockBuilder()->getId(),
    ...
    protected function _getSelectedProducts()
    {
        ...
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedBlockbuilderProducts());
        }
        return $products;
    }
     ...
     * @return array
     */
    public function getSelectedBlockbuilderProducts()
    {
        $products = [];
        if(!empty($this->getBlockBuilder()->getData('products'))){
        foreach ($this->getBlockBuilder()->getData('products') as $product) {
